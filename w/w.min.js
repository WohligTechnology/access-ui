...
Sn[X]=Sn[H]=Sn[Q]=Sn[nn]=Sn[tn]=Sn[rn]=Sn[en]=Sn[un]=Sn[on]=!0,Sn[B]=Sn[D]=Sn[J]=Sn[M]=Sn[q]=Sn[P]=Sn[K]=Sn["[object Map]"]=Sn[V]=Sn[Z]=Sn[Y]=Sn["[object Set]"]=Sn[G]=Sn["[object WeakMap]"]=!1;var Fn={};Fn[B]=Fn[D]=Fn[J]=Fn[M]=Fn[q]=Fn[X]=Fn[H]=Fn[Q]=Fn[nn]=Fn[tn]=Fn[V]=Fn[Z]=Fn[Y]=Fn[G]=Fn[rn]=Fn[en]=Fn[un]=Fn[on]=!0,Fn[P]=Fn[K]=Fn["[object Map]"]=Fn["[object Set]"]=Fn["[object WeakMap]"]=!1;var Nn={"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","Ç":"C","ç":"c","Ð":"D","ð":"d","È":"E","É":"E","Ê":"E","Ë":"E","è":"e","é":"e","ê":"e","ë":"e","Ì":"I","Í":"I","Î":"I","Ï":"I","ì":"i","í":"i","î":"i","ï":"i","Ñ":"N","ñ":"n","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","Ø":"O","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","ø":"o","Ù":"U","Ú":"U","Û":"U","Ü":"U","ù":"u","ú":"u","û":"u","ü":"u","Ý":"Y","ý":"y","ÿ":"y","Æ":"Ae","æ":"ae","Þ":"Th","þ":"th","ß":"ss"},Tn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#96;"},Ln={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'","&#96;":"`"},zn={"function":!0,object:!0},Bn={0:"x30",1:"x31",2:"x32",3:"x33",4:"x34",5:"x35",6:"x36",7:"x37",8:"x38",9:"x39",A:"x41",B:"x42",C:"x43",D:"x44",E:"x45",F:"x46",a:"x61",b:"x62",c:"x63",d:"x64",e:"x65",f:"x66",n:"x6e",r:"x72",t:"x74",u:"x75",v:"x76",x:"x78"},Dn={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},Mn=zn[typeof exports]&&exports&&!exports.nodeType&&exports,qn=zn[typeof module]&&module&&!module.nodeType&&module,Pn=zn[typeof self]&&self&&self.Object&&self,Kn=zn[typeof window]&&window&&window.Object&&window,Vn=qn&&qn.exports===Mn&&Mn,Zn=Mn&&qn&&"object"==typeof global&&global&&global.Object&&global||Kn!==(this&&this.window)&&Kn||Pn||this,Yn=m();"function"==typeof define&&"object"==typeof define.amd&&define.amd?(Zn._=Yn,define(function(){return Yn})):Mn&&qn?Vn?(qn.exports=Yn)._=Yn:Mn._=Yn:Zn._=Yn}.call(this);var firstapp=angular.module("firstapp",["ui.router","phonecatControllers","templateservicemod","ui-rangeSlider","navigationservice"]);firstapp.config(function($stateProvider,$urlRouterProvider,$httpProvider){$httpProvider.defaults.withCredentials=!0,$stateProvider.state("home",{url:"/home",templateUrl:"views/template.html",controller:"HomeCtrl"}).state("productdetail",{url:"/productdetail",templateUrl:"views/template.html",controller:"ProductdetailCtrl"}).state("wishlist",{url:"/wishlist",templateUrl:"views/template.html",controller:"WishlistCtrl"}).state("newarrivals",{url:"/newarrivals",templateUrl:"views/template.html",controller:"NewarrivalsCtrl"}).state("product",{url:"/product",templateUrl:"views/template.html",controller:"ProductCtrl"}).state("orderhistory",{url:"/orderhistory",templateUrl:"views/template.html",controller:"OrderhistoryCtrl"}).state("contact",{url:"/contact",templateUrl:"views/template.html",controller:"ContactCtrl"}).state("account",{url:"/account",templateUrl:"views/template.html",controller:"AccountCtrl"}).state("exclusive",{url:"/exclusive",templateUrl:"views/template.html",controller:"ExclusiveCtrl"}).state("distribution",{url:"/distribution",templateUrl:"views/template.html",controller:"DistributionCtrl"}).state("cart",{url:"/cart",templateUrl:"views/template.html",controller:"CartCtrl"}).state("searchresult",{url:"/searchresult",templateUrl:"views/template.html",controller:"SearchresultCtrl"}).state("about",{url:"/about",templateUrl:"views/template.html",controller:"AboutCtrl"}).state("checkout",{url:"/checkout",templateUrl:"views/template.html",controller:"CheckoutCtrl"}).state("storelocator",{url:"/storelocator",templateUrl:"views/template.html",controller:"StorelocatorCtrl"}).state("brand",{url:"/brand",templateUrl:"views/template.html",controller:"BrandsCtrl"}).state("login",{url:"/login",templateUrl:"views/template.html",controller:"LoginCtrl"}).state("forgotpassword",{url:"/forgotpassword",templateUrl:"views/template.html",controller:"forgotpasswordCtrl"}),$urlRouterProvider.otherwise("/home")}),firstapp.directive("img",function($compile,$parse){return{restrict:"E",replace:!1,link:function($scope,element,attrs){var $element=$(element);if(attrs.noloading)$($element).addClass("doneLoading");else{$element.after("<img src='img/loading.gif' class='loading' />");var $loading=$element.next(".loading");$element.load(function(){$loading.remove(),$(this).addClass("doneLoading")})}}}}),angular.module("phonecatControllers",["templateservicemod","navigationservice","ui.bootstrap","infinite-scroll","ngAnimate","ngDialog","valdr","angular-flexslider","ngSanitize","ui-rangeSlider"]).controller("HomeCtrl",function($scope,TemplateService,NavigationService,$timeout){$scope.template=TemplateService.changecontent("home"),$scope.menutitle=NavigationService.makeactive("Home"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.slides=["img/slider/1.jpg","img/slider/2.jpg","img/slider/3.jpg","img/slider/4.jpg"],$scope.products=[{image:"img/product/1.png"},{image:"img/product/2.png"},{image:"img/product/3.png"},{image:"img/product/4.png"}]}).controller("ProductCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService.changecontent("product"),$scope.menutitle=NavigationService.makeactive("Product"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.demo2={range:{min:0,max:10050},minPrice:0,maxPrice:10050},$scope.brands=[{name:"Apple"},{name:"nokia"},{name:"samsung"},{name:"mi"},{name:"micromax"}],$scope.max=5,$scope.isReadonly=!1,$scope.hoveringOver=function(value){$scope.overStar=value,$scope.percent=100*(value/$scope.max)},$scope.ratingStates=[{stateOn:"glyphicon-ok-sign",stateOff:"glyphicon-ok-circle"},{stateOn:"glyphicon-star",stateOff:"glyphicon-star-empty"},{stateOn:"glyphicon-heart",stateOff:"glyphicon-ban-circle"},{stateOn:"glyphicon-heart"},{stateOff:"glyphicon-off"}],$scope.$watch("rate",function(val){function sucess(data){console.log(data)}function error(response){console.log(response),alert("Can't post "+response.data+" Error:"+response.status)}if(val){var data={rating:val,user:"userId"};$http.post("yourUrl",data).then(sucess,error)}}),$scope.products=[{image:"img/product/iphone.jpg",image1:"img/product/iphone2.jpg",name:"Tempered Glass Screen Protector for iPhone 6 Plus",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"47000.00"},{image:"img/product/iphone6.jpg",image1:"img/product/iphone6ho.jpg",name:"Ultra Rugged Waterproof Case for iPhone 5/5s",desc:"This book is a treatise on the theory of ethics, very popular during the Renaissance. ",price:"48000.00"},{image:"img/product/iphone6ho.jpg",image1:"img/product/glass2.jpg",name:"Apple air",desc:"Flexible Glass Screen Protector With Applicator for LG G4 ",price:"42000.00"},{image:"img/product/8.jpg",image1:"img/product/5.jpg",name:"samsung",desc:"distracted by the readable content of a page when looking at its layout. ",price:"72000.00"},{image:"img/product/9.jpg",image1:"img/product/5.jpg",name:"nokia lumia",desc:"Many desktop publishing packages and web page editors now use Lorem Ipsum. ",price:"75000.00"},{image:"img/product/10.jpg",image1:"img/product/5.jpg",name:"resmi 1s",desc:"sometimes by accident, sometimes on purpose (injected humour and the like. ",price:"47000.00"},{image:"img/product/11.jpg",image1:"img/product/5.jpg",name:"micromax",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"41000.00"}]}).controller("CartCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService,$scope.template=TemplateService.changecontent("cart"),$scope.menutitle=NavigationService.makeactive("Cart"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("LoginCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService,$scope.template=TemplateService.changecontent("login"),$scope.menutitle=NavigationService.makeactive("Login"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("forgotpasswordCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService,$scope.template=TemplateService.changecontent("forgotpassword"),$scope.menutitle=NavigationService.makeactive("Forgotpassword"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("headerctrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.brandhover=["img/brands/acmemade.jpeg","img/brands/adonit.png","img/brands/autodrive.png","img/brands/b&oplay.png","img/brands/beats.png","img/brands/dell.png","img/brands/Adidas.png","img/brands/dolcegabbana.jpg","img/brands/gas.jpg","img/brands/gstarraw.png","img/brands/hp.png","img/brands/jackjones.png","img/brands/levis.png","img/brands/motorola.png","img/brands/sony.png","img/brands/tommy.jpg"]}).controller("ProductdetailCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("productdetail"),$scope.menutitle=NavigationService.makeactive("Productdetail"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.productdetail=["img/product/6.jpg","img/product/7.jpg","img/product/8.jpg","img/product/9.jpg","img/product/10.jpg","img/product/11.jpg","img/product/13.jpg"]}).controller("OrderhistoryCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("orderhistory"),$scope.menutitle=NavigationService.makeactive("Orderhistory"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("ContactCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("contact"),$scope.menutitle=NavigationService.makeactive("Contact"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("StorelocatorCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("storelocator"),$scope.menutitle=NavigationService.makeactive("StoreLocator"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("AccountCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("account"),$scope.menutitle=NavigationService.makeactive("Account"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("AboutCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("about"),$scope.menutitle=NavigationService.makeactive("About"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.celebimages=["img/BipashaBasu.jpg","img/KarishmaKapoor.jpg","img/MSG.jpg","img/NicolasAnelka.jpg","img/YusufPathan.jpg"]}).controller("NewarrivalsCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("newarrivals"),$scope.menutitle=NavigationService.makeactive("New Arrivals"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.products=[{image:"img/product/5.jpg",image1:"img/product/5.jpg",name:"Apple",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"47000.00"},{image:"img/product/6.jpg",image1:"img/product/5.jpg",name:"Apple Macbook",desc:"This book is a treatise on the theory of ethics, very popular during the Renaissance. ",price:"48000.00"},{image:"img/product/7.jpg",image1:"img/product/5.jpg",name:"Apple air",desc:"but the majority have suffered alteration in some form. ",price:"42000.00"},{image:"img/product/8.jpg",image1:"img/product/5.jpg",name:"samsung",desc:"distracted by the readable content of a page when looking at its layout. ",price:"72000.00"}]}).controller("CheckoutCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("checkout"),$scope.menutitle=NavigationService.makeactive("CheckOut"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav()}).controller("DistributionCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("distribution"),$scope.menutitle=NavigationService.makeactive("Distribution"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.distributer=["img/brands/autodrive.png","img/brands/hp.png","img/brands/sony.png","img/brands/b&oplay.png","img/brands/beats.png","img/brands/dell.png","img/brands/Adidas.png","img/brands/dolcegabbana.jpg","img/brands/gas.jpg","img/brands/acmemade.jpeg","img/brands/gstarraw.png","img/brands/adonit.png","img/brands/jackjones.png","img/brands/levis.png","img/brands/motorola.png","img/brands/tommy.jpg"]}).controller("ExclusiveCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("exclusive"),$scope.menutitle=NavigationService.makeactive("Exclusive"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.demo2={range:{min:0,max:10050},minPrice:0,maxPrice:10050},$scope.products=[{image:"img/product/5.jpg",image1:"img/product/5.jpg",name:"Tempered Glass Screen Protector for iPhone 6 Plus ",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"47000.00"},{image:"img/product/6.jpg",image1:"img/product/5.jpg",name:"Apple Macbook",desc:"This book is a treatise on the theory of ethics, very popular during the Renaissance. ",price:"48000.00"},{image:"img/product/7.jpg",image1:"img/product/5.jpg",name:"Apple air",desc:"but the majority have suffered alteration in some form. ",price:"42000.00"},{image:"img/product/8.jpg",image1:"img/product/5.jpg",name:"samsung",desc:"distracted by the readable content of a page when looking at its layout. ",price:"72000.00"},{image:"img/product/9.jpg",image1:"img/product/5.jpg",name:"nokia lumia",desc:"Many desktop publishing packages and web page editors now use Lorem Ipsum. ",price:"75000.00"},{image:"img/product/10.jpg",image1:"img/product/5.jpg",name:"resmi 1s",desc:"sometimes by accident, sometimes on purpose (injected humour and the like. ",price:"47000.00"},{image:"img/product/11.jpg",image1:"img/product/5.jpg",name:"micromax",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"41000.00"}]}).controller("BrandsCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("brand"),$scope.menutitle=NavigationService.makeactive("Brands"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.brandimages=["img/brands/acmemade.jpeg","img/brands/adonit.png","img/brands/autodrive.png","img/brands/b&oplay.png","img/brands/beats.png","img/brands/dell.png","img/brands/Adidas.png","img/brands/dolcegabbana.jpg","img/brands/gas.jpg","img/brands/gstarraw.png","img/brands/hp.png","img/brands/jackjones.png","img/brands/levis.png","img/brands/motorola.png","img/brands/sony.png","img/brands/tommy.jpg"]}).controller("WishlistCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("wishlist"),$scope.menutitle=NavigationService.makeactive("Wishlist"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.products=[{image:"img/product/5.jpg",image1:"img/product/5.jpg",name:"Apple",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"47000.00"},{image:"img/product/6.jpg",image1:"img/product/5.jpg",name:"Apple Macbook",desc:"This book is a treatise on the theory of ethics, very popular during the Renaissance. ",price:"48000.00"},{image:"img/product/7.jpg",image1:"img/product/5.jpg",name:"Apple air",desc:"but the majority have suffered alteration in some form. ",price:"42000.00"},{image:"img/product/8.jpg",image1:"img/product/5.jpg",name:"samsung",desc:"distracted by the readable content of a page when looking at its layout. ",price:"72000.00"}]}).controller("SearchresultCtrl",function($scope,TemplateService,NavigationService){$scope.template=TemplateService,$scope.template=TemplateService.changecontent("searchresult"),$scope.menutitle=NavigationService.makeactive("SearchResult"),TemplateService.title=$scope.menutitle,$scope.navigation=NavigationService.getnav(),$scope.products=[{image:"img/product/5.jpg",image1:"img/product/5.jpg",name:"Apple",desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. ",price:"47000.00"},{image:"img/product/6.jpg",image1:"img/product/5.jpg",name:"Apple Macbook",desc:"This book is a treatise on the theory of ethics, very popular during the Renaissance. ",price:"48000.00"},{image:"img/product/7.jpg",image1:"img/product/5.jpg",name:"Apple air",desc:"but the majority have suffered alteration in some form. ",price:"42000.00"},{image:"img/product/8.jpg",image1:"img/product/5.jpg",name:"samsung",desc:"distracted by the readable content of a page when looking at its layout. ",price:"72000.00"}]});var templateservicemod=angular.module("templateservicemod",[]);templateservicemod.service("TemplateService",function(){this.title="Home",this.meta="Google",this.metadesc="Home";var d=new Date;this.year=d.getFullYear(),this.init=function(){this.headermenu="views/headermenu.html",this.header="views/header.html",this.menu="views/menu.html",this.slider="views/slider.html",this.content="views/content/content.html",this.footermenu="views/footermenu.html",this.footer="views/footer.html"},this.changecontent=function(page){this.init();var data=this;return data.content="views/content/"+page+".html",data},this.init()}),templateservicemod.controller("submenuctrl",["$scope","TemplateService",function($scope,TemplateService,MainJson,$rootScope){$scope.submenuval=["views/content/brandhover.html","views/content/producthover.html"],$scope.submenu=[],$scope.showsubmenu=function(data){console.log(data),$scope.submenu[data]=!0},$scope.hidesubmenu=function(data){console.log(data),$scope.submenu[data]=!1}}]);var navigationservice=angular.module("navigationservice",[]).factory("NavigationService",function(){var navigation=[{name:"Brands",classis:"active",link:"#/brand",subnav:[{name:"Subnav1",classis:"active",link:"#/home"},{name:"Subnav2",classis:"active",link:"#/home"},{name:"Subnav3",classis:"active",link:"#/home"}]},{name:"products",active:"",link:"#/product",classis:"active",subnav:[]},{name:"exclusive",active:"",link:"#/exclusive",classis:"active",subnav:[]},{name:"new arrivals",active:"",link:"#/new arrivals",classis:"active",subnav:[]},{name:"deals",active:"",link:"#/deals",classis:"active",subnav:[]},{name:"about us",active:"",link:"#/about",classis:"active",subnav:[]},{name:"contact",active:"",link:"#/contact",classis:"active",subnav:[]}];return{getnav:function(){return navigation},makeactive:function(menuname){for(var i=0;i<navigation.length;i++)navigation[i].name==menuname?navigation[i].classis="active":navigation[i].classis="";return menuname}}});