var admin_url = "https://admin.accessworld.in/index.php/";
...
var adminbase = "https://admin.accessworld.in/";
  ...
  .factory("NavigationService", function ($http) {
    ...
    return {
      ...
      seach: function (search) {
        return $http.post(
          admin_url + "searchbyname?search=" + search,
          {},
          {
      ...
      getexclusiveandnewarrival: function (pageno, id, callback) {
        return $http
          .get(
            admin_url +
              "json/getexclusiveandnewarrival?id=" +
              id +
              "&pageno=" +
              pageno,
            {},
      ...
      getorderbyorderid: function (id, callback) {
        return $http
          .get(
            admin_url + "json/getorderbyorderid?id=" + id,
            {},
            {
              withCredentials: true,
            }
      ...
      getbrand: function (pageno, callback) {
        return $http
          .get(
            admin_url + "json/getbrand?maxrow=16&pageno=" + pageno,
            {},
            {
              withCredentials: true,
            }
      ...
      getAllBrands: function (pageno, callback) {
        return $http
          .get(
            admin_url + "json/getbrand?maxrow=500000&pageno=" + pageno,
            {},
            {
              withCredentials: true,
            }
      ...
      getsubscribe: function (email, callback) {
        return $http
          .get(
            admin_url + "json/getsubscribe?email=" + email,
            {},
            {
              withCredentials: true,
            }
      ...
      getproductdetails: function (id) {
        return $http.get(
          admin_url + "json/getproductdetails?id=" + id,
          {},
          {
            withCredentials: true,
          }
      ...
      search: function (search, callback) {
        return $http
          .get(
            admin_url + "json/searchbyname?search=" + search,
            {},
            {
              withCredentials: true,
            }
      ...
      getofferproducts: function (id, callback) {
        return $http
          .get(
            admin_url + "json/getofferproducts?offerid=" + id,
            {},
            {
              withCredentials: true,
            }
      ...
      getproductbybrand: function (pageno, brand, filters, callback) {
        ...
        return $http
          .get(
            admin_url +
              "json/getproductbycategory?category=" +
              filters.category +
              "&pageno=" +
              pageno +
              "&color=" +
      ...
      myorders: function (pageno, callback) {
        if ($.jStorage.get("user")) {
          return $http
            .get(
              admin_url +
                "json/getuserorders?user=" +
                $.jStorage.get("user").id +
                "&pageno=" +
                pageno,
              {
                withCredentials: true,
      ...
      getallproduct: function (pageno, callback) {
        return $http
          .get(
            admin_url + "json/getallproducts?pageno=" + pageno,
            {},
            {
              withCredentials: true,
            }
      ...
      deletecart: function (id, callback) {
        return $http
          .get(
            admin_url + "json/deletecart?id=" + id,
            {},
            {
              withCredentials: true,
            }
      ...
      getHomeProducts: function (callback) {
        return $http
          .get(
            admin_url + "json/getHomeProducts",
            {},
            {
              withCredentials: true,
            }
      ...
      getdiscountcoupon: function (couponcode) {
        return $http.post(
          admin_url + "json/getdiscountcoupon?couponcode=" + couponcode,
          {},
          {
            withCredentials: true,
          }
      ...
      getsinglecategory: function (id, callback) {
        return $http
          .get(
            admin_url + "json/getsinglecategory?categoryid=" + id,
            {},
            {
              withCredentials: true,
            }
